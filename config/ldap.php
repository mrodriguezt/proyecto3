            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'account_suffix' => env('LDAP_ACCOUNT_SUFFIX', '@santoscmi.com'),
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'srvcduio.santoscmi.com')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'dc=santoscmi,dc=com'),
                ...
                */
                ...
                'username' => env('ADLDAP_ADMIN_USERNAME', 'santoscmi\asistemas'),
                'password' => env('ADLDAP_ADMIN_PASSWORD', '$istem4s1dap'),
